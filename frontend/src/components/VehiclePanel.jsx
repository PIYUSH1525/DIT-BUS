    ...
    return (
        <div>
            ...
            <div onClick={() => {
                ...
                <h2 className='text-lg font-semibold'>₹{props.fare.Bus}</h2>
            </div>
            <div onClick={() => {
                props.setConfirmRidePanel(true)
                props.selectVehicle('Mini-van')
            }} className='flex border-2 active:border-black mb-2 rounded-xl w-full p-3  items-center justify-between'>
                ...
                <div className='-ml-2 w-1/2'>
                    <h4 className='font-medium text-base'>Mini-van <span><i className="ri-user-3-fill"></i>6</span></h4>
                    <h5 className='font-medium text-sm'>5 mins away </h5>
                    <p className='font-normal text-xs text-gray-600'>Spacious rides for groups</p>
                </div>
                <h2 className='text-lg font-semibold'>₹{props.fare['Mini-van']}</h2>
            </div>
            <div onClick={() => {
                props.setConfirmRidePanel(true)
